...
class My_Spider(scrapy.Spider):
	...
	def parse(self,response):
		...
		for code in codes:
			...
			laptop_selling_price=code.css('div._1vC4OE._2rQ-NK::text').extract()
			...
			pickle.dump({'Laptop Name: ':laptop_name,'Laptop Rating: ':laptop_rating,'Laptop Selling Price: ':laptop_selling_price},pickle_out)
		...
		if My_Spider.count<max_laptops:
			...
			next_page=response.css(My_Spider.css_selector+'::attr(href)').get()
